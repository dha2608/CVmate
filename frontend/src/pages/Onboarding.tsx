...
import { BriefcaseBusiness, GraduationCap, ArrowRight } from 'lucide-react';
import { useToastStore } from '@/store/toastStore';

const Onboarding = () => {
  const [selectedGoal, setSelectedGoal] = useState<
    'new-job' | 'internship' | 'career-switch' | null
  >(null);
      ...
      <div className="min-h-screen bg-white flex items-center justify-center p-4">
        <div className="max-w-2xl w-full space-y-8">
          <div className="text-center">
            ...
            <h1 className="text-4xl font-black text-jet-black mb-3">Chào mừng đến với CV Mate!</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {goals.map((goal) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-12 h-12 ${goal.color} rounded-lg flex items-center justify-center mb-4`}
                  >
