...
import { BriefcaseBusiness, UsersRound, Compass } from 'lucide-react';
        ...
        <div className="py-8">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 animate-fade-in">
            <div className="flex items-center gap-3 mb-6">
              <BriefcaseBusiness className="w-8 h-8 text-crimson-red" />
              <h1 className="text-3xl font-black text-jet-black">Tuyển dụng</h1>
            </div>

            <p className="text-gray-600 mb-6">
              Chúng tôi luôn tìm kiếm những người tài năng, đam mê giáo dục và công nghệ để cùng xây
              dựng CV Mate.
            </p>

            <section className="mb-8">
              <h2 className="text-2xl font-bold text-jet-black mb-3 flex items-center gap-2">
                <Compass className="w-5 h-5 text-crimson-red" />
                Sứ mệnh tuyển dụng
              </h2>
              <p className="text-sm text-gray-700 leading-relaxed">
                Mục tiêu của chúng tôi là giúp hàng triệu người tìm được công việc mơ ước thông qua
                CV, luyện phỏng vấn và cộng đồng hỗ trợ. Nếu bạn muốn tạo ra tác động thật sự cho
                người dùng, CV Mate là nơi dành cho bạn.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-bold text-jet-black mb-3 flex items-center gap-2">
                <UsersRound className="w-5 h-5 text-crimson-red" />
                Vị trí mở (demo)
              </h2>
            ...
            <section>
              ...
              <p className="text-sm text-gray-700 leading-relaxed">
                Nếu chưa có vị trí phù hợp, bạn vẫn có thể gửi CV để chúng tôi lưu lại cho các cơ
                hội trong tương lai.
              </p>
            </section>
          </div>
