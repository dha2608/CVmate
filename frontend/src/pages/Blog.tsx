      ...
      >
        <div className="bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm p-4 sm:p-6 mb-6 hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-3xl font-black text-jet-black dark:text-white mb-2">
                {t('blog.title')}
              </h1>
          ...
          <div className="bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm p-6 mb-6 hover:shadow-md transition-shadow">
            ...
            <form onSubmit={handleCreate} className="space-y-4">
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button type="submit" className="bg-accent hover:bg-red-700 text-white">
                  {t('blog.publish')}
                </Button>
              </div>
            </form>
        ...
        {activeTab === 'news' && (
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <h2 className="text-xl font-bold text-jet-black dark:text-white">
                {t('blog.latestNews')}
              </h2>
              <Button
                onClick={() => refreshNews()}
                        ...
                        {(article.image || article.coverImage) && (
                          <div className="h-64 w-full overflow-hidden bg-gray-100 dark:bg-gray-700 relative">
                            ...
                            <div
                              ...
                              onClick={(e) => e.stopPropagation()}
                            >
                              <BookmarkButton type="article" itemId={article._id} size="sm" />
                            </div>
                          </div>
                        )}
                        <div className="p-4">
                          <div className="flex items-center justify-between mb-2">
                            <span className="text-xs font-semibold text-accent dark:text-red-400 uppercase tracking-wider">
                              {article.category}
                            </span>
                            <span className="text-xs text-gray-400 dark:text-gray-500">
                          ...
                          <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2 leading-tight hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                            {article.title}
                          </h3>
