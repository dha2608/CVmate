        ...
        <div className="glass-card bg-white/90 dark:bg-gray-800/90 rounded-xl sm:rounded-2xl overflow-hidden">
          ...
          >
            ...
            <button
              ...
              className="absolute top-3 right-3 sm:top-4 sm:right-4 bg-white/95 dark:bg-gray-800/95 rounded-full p-2.5 sm:p-3 shadow-lg border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-white dark:hover:bg-gray-800 transition-all disabled:opacity-50 z-10"
