...
import { Trash2, Plus, GraduationCap, Sparkles } from 'lucide-react';
    ...
    <div className="bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm p-4 sm:p-6 space-y-4 relative group hover:shadow-md transition-shadow">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div className="space-y-2 col-span-2 md:col-span-1">
          ...
          />
          {!edu.institution?.trim() && <p className="text-xs text-amber-600">Required field</p>}
        </div>
        ...
        <div className="space-y-2 col-span-2 md:col-span-1">
          ...
          />
          {!edu.degree?.trim() && <p className="text-xs text-amber-600">Required field</p>}
        </div>
            ...
            <div className="flex justify-between items-center mb-2">
              ...
              <div className="flex items-center gap-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => onToggleCurrent(index, checked as boolean, edu)}
                />
                <label
