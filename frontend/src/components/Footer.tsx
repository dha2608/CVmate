        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-12 mb-10">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="#" className="text-gray-300 hover:text-crimson-red transition-colors" aria-label="Facebook">
                <Facebook size={20} />
              </a>
              <a href="#" className="text-gray-300 hover:text-crimson-red transition-colors" aria-label="Twitter">
                <Twitter size={20} />
              </a>
              <a href="#" className="text-gray-300 hover:text-crimson-red transition-colors" aria-label="LinkedIn">
                <Linkedin size={20} />
              </a>
              <a href="#" className="text-gray-300 hover:text-crimson-red transition-colors" aria-label="GitHub">
                <Github size={20} />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/builder" className="text-gray-300 hover:text-crimson-red transition-colors flex items-center gap-2">
                  <FileText size={14} />
                  {t('footer.cvBuilder')}
                </Link>
              </li>
              <li>
                <Link to="/interview" className="text-gray-300 hover:text-crimson-red transition-colors flex items-center gap-2">
                  <Video size={14} />
                  {t('footer.interviewPractice')}
                </Link>
              </li>
              <li>
                <Link to="/jobs" className="text-gray-300 hover:text-crimson-red transition-colors flex items-center gap-2">
                  <Briefcase size={14} />
                  {t('footer.jobSearch')}
                </Link>
              </li>
              <li>
                <Link to="/blog" className="text-gray-300 hover:text-crimson-red transition-colors flex items-center gap-2">
                  <BookOpen size={14} />
                  {t('footer.careerBlog')}
                </Link>
              </li>
              <li>
                <Link to="/community" className="text-gray-300 hover:text-crimson-red transition-colors flex items-center gap-2">
                  <Users size={14} />
                  {t('footer.community')}
                </Link>
              </li>
              <li>
                <Link to="/pricing" className="text-gray-300 hover:text-crimson-red transition-colors flex items-center gap-2">
                  <Briefcase size={14} />
                  {t('footer.pricing')}
                </Link>
              </li>
