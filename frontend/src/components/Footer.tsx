...
const Footer = () => {
  ...
  return (
    <footer
      id="footer"
      role="contentinfo"
      className="bg-jet-black text-white border-t border-gray-800 mt-auto"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-12 mb-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 text-sm mb-4 leading-relaxed">{t('footer.description')}</p>
            <div className="flex gap-4">
              <a
                href="#"
                className="text-gray-300 hover:text-crimson-red transition-colors"
                aria-label="Facebook"
              >
                <Facebook size={20} />
              </a>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link
                  to="/builder"
                  className="text-gray-300 hover:text-crimson-red transition-colors flex items-center gap-2"
                >
                  <ScrollText size={14} />
                  {t('footer.cvBuilder')}
                </Link>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              ...
              <li>
                <Link
                  to="/help"
                  className="hover:text-crimson-red transition-colors flex items-center gap-2"
                >
                  <CircleHelp size={14} />
                  {t('footer.helpCenter')}
                </Link>
